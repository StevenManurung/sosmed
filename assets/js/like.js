	...
	$(document).on('click','.like-btn', function(){
		...
		$.post('http://localhost/sosmed/core/ajax/like.php', {like:post_id, user_id:user_id}, function(){
 			counter.show();
	...
	$(document).on('click','.unlike-btn', function(){
		...
		$.post('http://localhost/sosmed/core/ajax/like.php', {unlike:post_id, user_id:user_id}, function(){
 			counter.show();
